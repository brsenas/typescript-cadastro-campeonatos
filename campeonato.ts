...
//Find - buscar um elemento em um Array
 function editarCampeonato(id:number) {
  ...
  (document.getElementById("nome") as HTMLInputElement).value = campeonato.nome; //Tipo Input do HTML
  (document.getElementById("categoria") as HTMLSelectElement).value = campeonato.categoria;// Tipo Select do HTML
